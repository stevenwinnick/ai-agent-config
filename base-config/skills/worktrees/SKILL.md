...
```bash
~/.claude/skills/worktrees/scripts/create.sh "<branch-name>"
```
...
```bash
~/.claude/skills/worktrees/scripts/list.sh
```
...
```bash
~/.claude/skills/worktrees/scripts/remove.sh "<branch-name>"
```
...
```bash
~/.claude/skills/worktrees/scripts/clean-all.sh
```
...
```bash
~/.claude/skills/worktrees/scripts/switch.sh "<name>"
```
