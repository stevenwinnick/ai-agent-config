...
Use `which shw` to verify the installation and identify the installation path. If the installed binary appears out of date relative to the source checkout, it can be reinstalled using the instructions in the repo.
