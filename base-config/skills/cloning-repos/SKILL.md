---
name: cloning-repos
description: Clones a GitHub repo into the preferred worktree directory structure. Use when the user wants to clone a new repository.
...
```bash
~/.claude/skills/cloning-repos/scripts/clone-repo.sh $ARGUMENTS
```
