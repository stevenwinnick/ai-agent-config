---
name: creating-plans
description: Generates a detailed implementation plan for review before coding. Use when approaching a complex task where the best approach is not immediately clear.
---
