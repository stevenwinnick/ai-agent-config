---
name: managing-shell-setup
description: Adds, modifies, or removes settings in Steven's custom shell setup section of ~/.zshrc. Use when making changes to personal shell configuration.
---
