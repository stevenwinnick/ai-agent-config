...
description: Suggest and implement improvements to your own configuration or that of other AI agents. Use when you identify ways to make yourself more helpful or when the user asks for changes to agent behavior.
---
